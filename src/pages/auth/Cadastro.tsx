    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-2/5 bg-gradient-to-br from-primary to-primary/70 p-12 flex-col justify-between text-primary-foreground">
        ...
        <p className="text-primary-foreground/60 text-sm">
          © 2024 Agro GFI — Gestão de Fazenda Inteligente. Todos os direitos reservados.
        </p>
      </div>
        ...
        <div className="max-w-2xl w-full space-y-8">
          ...
          <Card className="border-border shadow-lg">
            <CardHeader className="space-y-1">
              ...
              <CardDescription>Preencha os dados abaixo para começar a usar o Agro GFI</CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
