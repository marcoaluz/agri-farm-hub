...
export default function Dashboard() {
  ...
  const consolidadoKpis = useMemo(() => {
    ...
    return consolidadoV2.reduce((acc: any, row: any) => ({
      ...
      custo_propriedade: (acc.custo_propriedade ?? 0) + Number(row.custo_propriedade || 0),
      ...
      custo_safra_ativa: 0, custo_propriedade: 0, receita_paga: 0, resultado_parcial: 0, custo_por_ha: 0,
